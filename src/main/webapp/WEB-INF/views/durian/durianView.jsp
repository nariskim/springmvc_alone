...
<input type="hidden" class="form-control" name="oymbSeq"
			...
			<div class="row">
						...
						<div class="col-12 col-sm-8 col-lg-4">
							<input type="text" readonly class="form-control" id="oymbName"
						...
						<div class="col-12 col-sm-8 col-lg-4">
							<input type="text" readonly class="form-control" id="oymbNameEng"
					...
					<div class="row">
						...
						<div class="col-12 col-sm-8 col-lg-4">
							<input type="text" readonly class="form-control" id="oymbId" name="oymbId"
						...
						<div class="col-12 col-sm-8 col-lg-4">
							<input type="text" readonly class="form-control" id="oymbNickName"
					...
					<div class="row">
						...
						<div class="col-12 col-sm-8 col-lg-4">
							<input type="radio" class="btn-check" id="oymbGenderCd" name="oymbGenderCd" autocomplete="off" value="<c:if test="${vo.oymbGenderCd eq 3 }">checked</c:if>">
							<label class="btn btn-outline-dark">남자</label>
							<input type="radio" class="btn-check" id="oymbGenderCd" name="oymbGenderCd" autocomplete="off" value="<c:if test="${vo.oymbGenderCd eq 4 }">checked</c:if>">
							<label class="btn btn-outline-dark">여자</label>
							<input type="radio" class="btn-check" id="oymbGenderCd" name="oymbGenderCd" autocomplete="off" value="<c:if test="${vo.oymbGenderCd eq 5 }">checked</c:if>">
...
<input type="text" id="sample6_extraAddress" placeholder="참고항목">
					...
					<div class="row">
						...
						<div class="col-12 col-sm-8 col-lg-4">
							...
							<select class="form-select form-select-sm mb-1" id="oympTelecomCd" name="oympTelecomCd" disabled>
						...
						<option value="31" <c:if test="${item.oympTelecomCd eq 31 }">selected</c:if>>알뜰폰</option>
								...
								<input type="text" readonly class="form-control" id="oympNumber"
